...
// ported from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/9e11cbddb656437a7ad02474635743553e7859c3/types/emscripten/index.d.ts
// Copyright (c) 2014-2024 Kensuke Matsuzaki, Periklis Tsirakidis, Bumsik Kim, and Louis DeScioli. All rights reserved. MIT License.
// Changes by @takker99
...
declare namespace Emscripten {
  ...
  type TypeCompatibleWithC = number | string | unknown[] | boolean;
...
declare namespace FS {
  ...
  function syncfs(populate: boolean, callback: (e: unknown) => unknown): void;
  function syncfs(callback: (e: unknown) => unknown, populate?: boolean): void;
  function mount(
    type: Emscripten.FileSystemType,
    opts: unknown,
    mountpoint: string,
  ...
  function ioctl(stream: FSStream, cmd: unknown, arg: unknown): unknown;
  function readFile(
    path: string,
  ...
  function init(
    ...
    output: null | ((c: number) => unknown),
    error: null | ((c: number) => unknown),
  ): void;
...
declare const MEMFS: Emscripten.FileSystemType;
declare const NODEFS: Emscripten.FileSystemType;
declare const IDBFS: Emscripten.FileSystemType;

// https://emscripten.org/docs/porting/connecting_cpp_and_javascript/Interacting-with-code.html
type StringToType<R extends unknown> = R extends Emscripten.JSType ? {
    number: number;
    string: string;
...
declare function addRunDependency(id: unknown): void;
declare function removeRunDependency(id: unknown): void;
...
declare const ALLOC_STATIC: number;
declare const ALLOC_DYNAMIC: number;
declare const ALLOC_NONE: number;

declare const HEAPU8: EmscriptenModule["HEAPU8"];
declare const HEAPU32: EmscriptenModule["HEAPU32"];
declare const HEAP32: EmscriptenModule["HEAP32"];
declare const _malloc: EmscriptenModule["_malloc"];

interface Asyncify {
  handleAsync(startAsync: () => Promise<number>): number | undefined;
}
